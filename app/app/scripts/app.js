...
angular 
    .module('ngSlimSampleApp', [
        ...
        'ngSanitize',
        'ngTouch',
        'ui.router', 'ui.grid', 'ui.bootstrap.showErrors', 
    ...
    .config(function($stateProvider, $urlRouterProvider, $authProvider, $httpProvider, $provide, urlConfig, showErrorsConfigProvider) {
    ...
    }).run(function($rootScope, $state, accService) {

        $rootScope.accService = accService;
